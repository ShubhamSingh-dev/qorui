---
title: Installation
description: Getting started with qorui
icon: ListStart
---
...
```bash tab="pnpm"
pnpm dlx shadcn@latest add https://qorui/r/utils.json
```
...
```jsx
import Card05 from "@/components/qorui/card-05";
 ...
 */
import AICardGeneration from "@/components/qorui/AICardGeneration";
