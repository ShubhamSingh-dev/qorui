...
import { Users, Mail, Plus, Settings2, Shield, MapPin } from "lucide-react";
import { Github, Linkedin } from "@/components/qorui/icons";
                  ...
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="flex items-center gap-2">
                      {member.social.github && (
                        <a
                          href="https://github.com/kokonut-labs/qorui"
                          target="_blank"
